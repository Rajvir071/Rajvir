...
def notice():
	...
	os.system("xdg-open https://www.facebook.com/Rajvir.071")
	subprocess.check_output(["am", "start", "https://github.com/Rajvir071/Rajvir/blob/main/Approved-R.txt"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/Rajvir071/Rajvir/blob/main/Approved-R.txt').text
			if basesplit in plr:
				key = basesplit
